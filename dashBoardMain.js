...
const applicantsData = [
    { id: 1, name: 'Emily Chen', age: 8, guardian: 'parent@example.com', appliedFor: 'Painting Workshop' },
    { id: 2, name: 'Liam Smith', age: 10, guardian: 'guardian@example.com', appliedFor: 'Drama Club' },
    { id: 3, name: 'Sophia Wong', age: 7, guardian: 'family@example.com', appliedFor: "Children's Choir" },
    { id: 4, name: 'Ethan Brown', age: 11, guardian: 'caretaker@example.com', appliedFor: 'Dance Performance' },
    { id: 5, name: 'Olivia Taylor', age: 9, guardian: 'parent2@example.com', appliedFor: 'Creative Writing' },
];
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Age Distribution of Applicants'
                }
            }
        }
    });
